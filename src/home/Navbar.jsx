...
const Navbar = () => {
    ...
    return (
        <div className='sticky top-0 z-10 backdrop-blur bg-white/60 flex justify-between items-center py-5'>
            <Drawer className='backdrop-blur-md' open={open} onClose={() => setOpen(false)} anchor='top'>
                <div className='py-5'>
                    ...
                    <div onMouseEnter={() => setOpenProduct(true)} onMouseLeave={() => setOpenProduct(false)} className='mx-4 py-2 hover:bg-sky-100 transition-all cursor-pointer px-3 rounded'>
                        <Link to='#'  className='flex items-center'>
                            <p className='font-medium'>Products</p>
                            <img className='w-3 ml-2' src={arrowDown} alt='arrDown' />
                        </Link>
                    </div>
                    <div onMouseEnter={() => setOpenResources(true)} onMouseLeave={() => setOpenResources(false)} className='mx-4 py-2 hover:bg-sky-100 transition-all cursor-pointer px-3 rounded'>
                        <Link to='#'  className='flex items-center'>
