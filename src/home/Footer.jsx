        ...
        <div className='flex flex-col items-center justify-center md:mx-auto mx-2 my-10 marginCSS p-2'>
            <div className='md:flex-row flex-col flex justify-between items-center w-full'>
                <div className='md:mr-16 mt-10'>
                    <h3 className=' dark:text-white font-semibold text-xl'>Do you want to know about the latest posts?</h3>
            ...
            <div className='flex lg:flex-row flex-col justify-between items-center w-full my-16'>
                ...
                <div className='dark:text-white text-black flex justify-between items-center flex-wrap md:flex-nowrap my-8'>
                    <div className='mr-8 serviceCSS'>
                        ...
                        <div className='flex items-center'>
                            <p>Solutions</p>
                            <span className='ml-2 border-2 transition-all hover:text-black hover:bg-sky-50 dark:border-white/75 border-black/75 px-3 rounded-full'>New</span>
                        </div>
            ...
            <div className='flex justify-between flex-col-reverse md:flex-row items-center w-full'>
                <div>
                    <p className='dark:text-white font-semibold'>© Built in 2023</p>
                </div>
