...
const Post = () => {
    ...
    return (
        ...
        <div className='flex flex-col my-8'>
            <div className='w-full border-b-2 mb-3 border-black/60 p-2'>
                <h1 className='font-semibold sm:text-xl text-base'>{data.post.title}</h1>
            </div>
            ...
            <div className='flex items-center mt-8 md:mx-16 mx-5 mb-5'>
                ...
                <div>
                    ...
                    <span className=' font-medium text-black/70 text-sm'>{data.post.author.title}</span>
                </div>
            </div>
            <div className=' md:mx-12 mx-2 font-medium text-lg' dangerouslySetInnerHTML={{__html: sanitizeHtml(data.post.content.html) }}></div>
            <div className='md:mx-12 mx-2 font-medium text-xl mt-16'>
